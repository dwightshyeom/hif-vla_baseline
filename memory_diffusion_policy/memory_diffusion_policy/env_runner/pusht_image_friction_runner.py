...
from memory_diffusion_policy.env.pusht.pusht_image_friction_env import PushTImageFrictionEnv
...
class PushTImageFrictionRunner(BaseImageRunner):
    """
    ...
    def run(self, policy: BaseImagePolicy, epoch: int = 0):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(total=self.max_steps,
                desc=f"Eval PushTImageFriction {chunk_idx+1}/{n_chunks}",
            ...
            while not done:
                ...
                def _set_progress_overlay(env_wrapper):
                    inner = env_wrapper.env.env  # VideoRecordingWrapper -> PushTImageFrictionEnv
