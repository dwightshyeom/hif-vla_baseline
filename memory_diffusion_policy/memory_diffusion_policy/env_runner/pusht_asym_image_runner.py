...
from memory_diffusion_policy.env.pusht.pusht_asym_image_env import PushTAsymImageEnv
...
class PushTAsymImageRunner(BaseImageRunner):
    def __init__(self,
            output_dir,
            n_train=10,
            n_train_vis=3,
    ...
    def run(self, policy: BaseImagePolicy, epoch: int = 0):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(total=self.max_steps, desc=f"Eval PushTAsymImageRunner {chunk_idx+1}/{n_chunks}",
