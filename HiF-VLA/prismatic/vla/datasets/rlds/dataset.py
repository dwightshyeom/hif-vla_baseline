...
def make_dataset_from_rlds(
    ...
    *,
    ...
    def restructure(traj):
        ...
        if "libero" in name:
            episode_idx = traj["traj_metadata"]["traj_id"]
        else:
            episode_idx = traj["traj_metadata"]["episode_metadata"]["episode_id"]
        new_obs = {}
...
def apply_trajectory_transforms(
    ...
    *,
    ...
    # for data in iter(dataset.as_numpy_iterator()):
    #     traj_transforms.chunk_act_obs(data, window_size=window_size,future_action_window_size=future_action_window_size)
...
def make_interleaved_dataset(
    ...
    *,
    ...
    for dataset_kwargs, threads, reads in zip(
        ...
        dataset = dataset.traj_map(traj_transforms.extract_motion_tf,num_parallel_calls=threads)
        # motion_save(dataset)
        dataset = dataset.traj_map(traj_transforms.read_mv_from_json,num_parallel_calls=threads)
