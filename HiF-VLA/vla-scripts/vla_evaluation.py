...
# model, action_head, proprio_projector, noisy_action_projector, processor, motion_manager, motion_encoder, use_x0_prediction=cfg.use_x0_prediction
class DualSystemCalvinEvaluation(CalvinBaseModel):
    def __init__(self, model, action_head, proprio_projector, processor, motion_manager, motion_encoder, use_x0_prediction=False):
        super().__init__()
        ...
        self.motion_token = motion_manager.get_motion_token(batch_size=1)
    ...
    def step(self, obs, instruction, step, his_motion_seq):
        """
        Args:
        ...
        # inputs["pixel_values"] = primary_pixel_values
