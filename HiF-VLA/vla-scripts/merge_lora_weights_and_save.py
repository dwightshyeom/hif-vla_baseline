...
class ConvertConfig:
    ...
    base_checkpoint: Union[str, Path] = "openvla/openvla-7b"                   # Base model checkpoint path/dir (either openvla/openvla-7b or whichever model you fine-tuned / resumed training from)
