...
if __name__ == "__main__":
    ...
    parser.add_argument("--libero_raw_data_dir", type=str,default="/liujiacheng/linminghui/datasets/modified_libero_rlds",
                        help="Path to directory containing raw HDF5 dataset. Example: ./LIBERO/libero/datasets/libero_spatial", required=True)
    parser.add_argument("--libero_target_dir", type=str,default="/liujiacheng/linminghui/datasets/reepisode_libero",
